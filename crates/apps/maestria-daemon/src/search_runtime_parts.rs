...
impl Clone for SearchRuntime {
    fn clone(&self) -> Self {
        Self {
            ...
            late_interaction_shadow_reranker: self.late_interaction_shadow_reranker.clone(),
            late_interaction_active_reranker: self.late_interaction_active_reranker.clone(),
            late_interaction_active_controller: self.late_interaction_active_controller.clone(),
