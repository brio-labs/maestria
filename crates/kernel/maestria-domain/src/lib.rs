...
pub use crate::search::{
    ...
    SearchExecutionResource, SearchExecutionUsage, SearchExpansionStrategy, SearchIntent,
    SearchLaneStatus, SearchOutcome, SearchPlan, SearchPlanBuilder, SearchRewriteAccounting,
    SearchRewriteOrigin, SearchRewriteStage, SearchStage, SearchStatus, SearchStopReason,
    SearchTrace, SearchTraceCandidate, SearchTraceCandidateDto, SearchTraceConstraintScore,
