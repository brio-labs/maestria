...
impl KernelState {
    ...
    pub(super) fn replay_artifact_events(
        &mut self,
        event: &DomainEvent,
    ) -> Result<(), DomainError> {
        match event {
    ...
    pub(super) fn replay_generation_events(
        &mut self,
        event: &DomainEvent,
    ) -> Result<(), DomainError> {
        match event {
            DomainEvent::IndexGenerationStarted {
                ...
                *corpus_snapshot,
                fingerprint.clone(),
                representation_fingerprint.clone(),
    ...
    pub(super) fn replay_memory_events(&mut self, event: &DomainEvent) -> Result<(), DomainError> {
        match event {
    ...
    pub(super) fn replay_orchestration_events(
        &mut self,
        event: &DomainEvent,
    ) -> Result<(), DomainError> {
        match event {
    ...
    pub(super) fn replay_federation_events(
        &mut self,
        event: &DomainEvent,
    ) -> Result<(), DomainError> {
        match event {
